...
2. Add i18n keys in `locales/en.json` and `locales/zh-TW.json`
3. Register route in `router/index.ts`

## Testing Patterns

- No unit tests — quality via CI/CD pipeline
- Run `pnpm before-commit` before committing
```
